...
class AODNet(nn.Module):
	...
	def forward(self, x):
		...
		# x2 = self.silu(self.conv2(x1))
		#
		# concat1 = torch.cat((x1, x2), 1)
		# x3 = self.silu(self.conv3(concat1))
		#
		# concat2 = torch.cat((x2, x3), 1)
		# x4 = self.silu(self.conv4(concat2))
		#
		# concat3 = torch.cat((x1, x2, x3, x4), 1)
		# x5 = self.silu(self.conv5(concat3))
		#
		# clean_image = self.silu((x5 * x) - x5 + 1)
