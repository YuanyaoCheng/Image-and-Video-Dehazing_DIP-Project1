...
class MyDataset(data.Dataset):
	...
	def __getitem__(self, index):
		...
		data_orig = Image.open(data_orig_path).resize((480,640),Image.Resampling.LANCZOS)
		data_hazy = Image.open(data_hazy_path).resize((480,640),Image.Resampling.LANCZOS)
